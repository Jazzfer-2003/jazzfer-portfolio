...
function jazzfer_seo_descriptions() {
    ...
    if (is_page('portfolio')) {
        return "Explore Jazzfer Inigo's projects — the Palale Enrollment System, academic web apps, and this WordPress portfolio built with PHP, MySQL, JavaScript, and more.";
    }
