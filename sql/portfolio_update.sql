...
-- Portfolio update for ID 44 - added 11 Cisco NetAcad certificates (2023-2025)
USE wordpress;
UPDATE wp_posts SET post_content='<!-- wp:html -->
<div class="page-section-wide">
  <h2 class="reveal">My Certifications</h2>
  ...
  <div class="card-grid">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-10.png" alt="Networking Basics" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-11.png" alt="Computer Hardware Basics" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-12.png" alt="Introduction to Cybersecurity" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-13.png" alt="Python Essentials 1" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-14.png" alt="Ethical Hacker" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-15.png" alt="Endpoint Security" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-16.png" alt="Network Defense" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-17.png" alt="Cyber Threat Management" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-18.png" alt="Digital Safety and Security Awareness" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-19.png" alt="Introduction to Data Science" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
    ...
    <div class="card-item reveal">
      <div class="card-img"><img src="http://localhost/wordpress/wp-content/uploads/certs/cert-20.png" alt="Security and Connectivity Support" loading="lazy" class="cert-img" /></div>
      <div class="card-body">
